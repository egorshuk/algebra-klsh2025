...
\begin{example}
    ...
    \begin{figure}[ht]
        ...
        \begin{asy}
            ...
            // Кривые "ниточки"
            draw(start[0]..(0.3, -0.5)..end[1], blue4+linewidth(1)); // Р -> Ы
            draw(start[1]..(0.6, -0.5)..end[0], blue4+linewidth(1)); // Ы -> Р
            draw(start[2]..(2.4, -1.4)..end[3], longdashed+red4+linewidth(1)); // Б -> А
            draw(start[3]..(2.9, -0.8)..(2.1, -1.2)..end[2], longdashed+red4+linewidth(1)); // А -> Б
...
\begin{example}
    ...
    \begin{figure}[ht]
        ...
        \begin{asy}
            ...
            // Кривые "ниточки"
            draw(start[0]{(1, -1)}..(mid[1]+(0, 0.4)), blue4+linewidth(1)); // К -> Н
            draw(start[1]{(1, -2)}..(mid[3]+(0, 0.4)), blue4+linewidth(1)); // И -> О
            draw(start[2]{(1, -3)}..(mid[2]+(0, 0.4)), blue4+linewidth(1)); // Н -> К
            draw(start[3]{(-6, -1)}..(mid[0]+(0, 0.4)), blue4+linewidth(1)); // О -> И

            draw(mid[0]{(0.5, -2)}..end[1], longdashed+red4+linewidth(1)); // Н -> О
            draw(mid[1]{(1, -2)}..end[0], longdashed+red4+linewidth(1)); // О -> Н
            draw(mid[2]{(3, -1)}..end[3], longdashed+red4+linewidth(1)); // К -> И
            draw(mid[3]{(0, -2)}..end[2], longdashed+red4+linewidth(1)); // И -> К
